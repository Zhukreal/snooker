class ShotCandidate{
	constructor(table, cueball, cueball_cushion, object_path){
		  this.table = table;
	...
	canon_shot(table, cueball, cueball_cushion, target, object_ball, object_ball_cushion, pot_ball){
