// Данный класс используется для остановки шарика
// после столкновения с бортами стола


class Cushion {
	constructor(x, y, length, direction, depth){
  ...
  return null;
	...
	impact_in_line(start, end, position, radius){
